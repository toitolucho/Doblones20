...
namespace CLCLN.Sistema
{
    public class PCsConfiguracionesCLN
    {
        ...
        public bool InsertarPCConfiguracion(string IDPC, string IPPC, int NumeroAgencia, byte CodigoMonedaSistema, byte CodigoMonedaRegion, decimal PorcentajeImpuesto, bool ContabilidadIntegrada)
        {
        ...
        //[System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public bool ActualizarPCConfiguracion(int NumeroPC, string IDPC, string IPPC, int NumeroAgencia, byte CodigoMonedaSistema, byte CodigoMonedaRegion, decimal PorcentajeImpuesto, bool ContabilidadIntegrada)
        {
