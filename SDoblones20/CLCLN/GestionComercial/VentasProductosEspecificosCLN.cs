...
namespace CLCLN.GestionComercial
{
    ...
    public class VentasProductosEspecificosCLN
    {
        ...
        public bool InsertarVentaProductoEspecifico(int NumeroAgencia, int NumeroVentaProducto, string CodigoProducto, string CodigoProductoEspecifico, int TiempoGarantiaPE, bool? Entregado)
        {
