...
namespace CLCLN.GestionComercial
{
    ...
    public class InventariosProductosCLN
    {
        ...
        {
            DSDoblones20GestionComercial.InventarioProductosDataTable InventariosProductos = Adapter.GetDataBy1(NumeroAgencia, CodigoProducto);
        ...
        {
            return Adapter.GetDataBy1(NumeroAgencia, CodigoProducto);
        }
