...
namespace CLCLN.GestionComercial
{
    ...
    public class VentasProductosCLN
    {
        ...
        {
            DSDoblones20GestionComercial.VentasProductosDataTable VentasProductos = Adapter.GetDataBy1(NumeroAgencia, NumeroVentaProducto);
        ...
        public DataTable ObtenerVentaProducto(int NumeroAgencia, int NumeroVentaProducto)
            {
            return Adapter.GetDataBy1(NumeroAgencia, NumeroVentaProducto);
        }
