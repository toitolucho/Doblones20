...
namespace CLCLN.GestionComercial
{
    ...
    public class ProductosTiposCLN
    {
        ...
        public bool InsertarProductoTipo(int? CodigoTipoProductoPadre, string NombreTipoProducto, string NombreCortoTipoProducto, string DescripcionTipoProducto, byte Nivel)		
        {
        ...
        public bool ActualizarProductoTipo(int CodigoTipoProducto, int? CodigoTipoProductoPadre, string NombreTipoProducto, string NombreCortoTipoProducto, string DescripcionTipoProducto, byte Nivel)		
        {
