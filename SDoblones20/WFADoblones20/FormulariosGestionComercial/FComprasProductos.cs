...
namespace WFADoblones20.FormulariosGestionComercial
{
    public partial class FComprasProductos : Form
    {
        ...
        private void btnPagar_Click(object sender, EventArgs e)
        {
            ...
            FCompraProductosAdministradorPagos _FCompraProductosAdministradorPagos = new FCompraProductosAdministradorPagos(NumeroAgencia, NumeroCompraProducto, CodigoUsuario);
