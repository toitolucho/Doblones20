                ...
                if (dtGVTransacciones.RowCount > 0 && dtGVTransacciones.CurrentRow != null)
                {
                    ...
                    switch (TipoOperacion)
                    {
                        ...
                        case "C": //Cancelacion y pago para el Contador
                            ...
                            //{
                                FCompraProductosAdministradorPagos _FCompraProductosAdministradorPagos = new FCompraProductosAdministradorPagos(NumeroAgencia, NumeroTransaccion, CodigoUsuario);
