...
namespace WFADoblones20.FormulariosSistema
{
    public partial class FPrincipal : Form
    {
        ...
        public static void Productos(object sender, EventArgs e)
        {
            ...
            if (PermisosInterface.Rows.Count > 0)
            {
                FProductos fproductos = new FProductos(bool.Parse(PermisosInterface.Rows[0][0].ToString()), bool.Parse(PermisosInterface.Rows[0][1].ToString()), bool.Parse(PermisosInterface.Rows[0][2].ToString()), bool.Parse(PermisosInterface.Rows[0][3].ToString()));
        ...
        public static void TiposProductos(object sender, EventArgs e)
        {
            FProductosTipos fproductostipos = new FProductosTipos();
            fproductostipos.ShowDialog();
        }
