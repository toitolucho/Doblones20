...
namespace WFADoblones20.FormulariosGestionComercial
{
    public partial class FProductos : Form
    {
		...
		public void actualizarPreciosVenta()
        {
            ...
            String ProductosDetalleXML = String.Format("<Productos><ProductosHistorial> <CodigoProducto>{0}</CodigoProducto> <CantidadRecepcion>0</CantidadRecepcion> <PrecioUnitarioCompra>0</PrecioUnitarioCompra> <MontoGastoIncremento>0</MontoGastoIncremento></ProductosHistorial></Productos>", tBCodigoProducto.Text);
