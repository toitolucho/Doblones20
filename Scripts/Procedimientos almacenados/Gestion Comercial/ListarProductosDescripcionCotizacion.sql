...
BEGIN
	...
	SELECT	P.CodigoProducto, 
			...
			PIM1.NumeroImagen, 
			CAST(PIM1.RutaImagenProducto AS VARCHAR(4000)) AS RutaImagenProducto1, 
			CAST(PIM2.RutaImagenProducto AS VARCHAR(4000)) AS RutaImagenProducto2, 
			CAST(PIM3.RutaImagenProducto AS VARCHAR(4000)) AS RutaImagenProducto3
	FROM Productos P
