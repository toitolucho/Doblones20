...
AS
BEGIN
	INSERT INTO dbo.PCsConfiguraciones(IDPC, IPPC, NumeroAgencia, CodigoMonedaSistema, CodigoMonedaRegion, PorcentajeImpuesto, ContabilidadIntegrada)
	VALUES (@IDPC, @IPPC, @NumeroAgencia, @CodigoMonedaSistema, @CodigoMonedaRegion, @PorcentajeImpuesto, @ContabilidadIntegrada)
END
GO
...
AS
BEGIN
	SELECT NumeroPC, IDPC, IPPC, NumeroAgencia, CodigoMonedaSistema, CodigoMonedaRegion, PorcentajeImpuesto, ContabilidadIntegrada
	FROM dbo.PCsConfiguraciones
	ORDER BY NumeroPC
END
GO
...
BEGIN
	SELECT	PC.NumeroPC, PC.IDPC, PC.NumeroAgencia, PC.CodigoMonedaSistema, M1.NombreMoneda AS NombreMonedaSistema, 
			...
			PC.ContabilidadIntegrada, PorcentajeImpuestoCompraConFactura, PorcentajeImpuestoCompraSinFactura 
