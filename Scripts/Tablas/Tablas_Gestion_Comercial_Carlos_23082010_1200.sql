...
(
CodigoProductoPadre				CHAR(15)		NOT NULL,
CodigoProductoComponente		CHAR(15)		NOT NULL,
NumeroComponente				INT				NULL,
Cantidad						INT				NULL,
CONSTRAINT PK_ProductosCompuestos PRIMARY KEY(CodigoProductoPadre, CodigoProductoComponente),
CONSTRAINT FK_ProductosCompuestosPadre FOREIGN KEY (CodigoProductoPadre) REFERENCES Productos (CodigoProducto),
CONSTRAINT FK_ProductosCompuestosComponenete FOREIGN KEY (CodigoProductoComponente) REFERENCES Productos (CodigoProducto),
CONSTRAINT U_CantidadProductos CHECK(Cantidad > 0)
)
GO
